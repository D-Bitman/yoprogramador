  ...
  return (
    <div className="App">
      ...
      <div className="share-button">
        ...
        <a title="Whatsapp" href="https://api.whatsapp.com/send?text=Te%20invito%20a%20acompañarme%20en%20mi%20Switch%20Profesinal%20https://ebookyoprogramador.vercel.app/" target="_blank" rel="noreferrer"><i className="fab fa-whatsapp" aria-hidden="true"></i></a>
      </div>
